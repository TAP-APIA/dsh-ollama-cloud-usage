...
function QuotaRing({ wide, api }) {
  ...
  const [popPos, setPopPos] = (0, import_react.useState)(null);
  const refresh = async () => {
    setLoading(true);
    setError(null);
    try {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: rootRef, style: { position: "relative", display: "inline-flex", alignItems: "center" }, children: [
    ...
    open && popPos && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        style: {
          position: "fixed",
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontWeight: 500 }, children: "Ollama Cloud \u914D\u989D" }),
            loading && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 11 }, children: "\u5237\u65B0\u4E2D\u2026" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BarRow, { label: "5 \u5C0F\u65F6\u7A97\u53E3", used: sessionUsed }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BarRow, { label: "7 \u5929\u7A97\u53E3", used: weeklyUsed }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
              style: {
                ...
                fontSize: 12,
                marginTop: 2,
                color: error ? "var(--dsw-alias-state-error-primary)" : "var(--dsw-alias-label-tertiary)"
              },
              children: error ? error : noKey ? "\u5C1A\u672A\u914D\u7F6E API Key\uFF0C\u5C55\u5F00\u4E0B\u65B9\u8F93\u5165\u3002" : usage?.cost !== void 0 ? `\u8FD1 4 \u5468\u8D39\u7528\uFF1A$${usage.cost}` : ""
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { borderTop: "1px solid var(--dsw-alias-border-l2)", marginTop: 8, paddingTop: 8 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { display: "inline-block", transition: "transform .12s", transform: keyOpen ? "rotate(90deg)" : "none" }, children: "\u25B8" }),
                  "API Key"
                ]
              }
            ),
            keyOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 6, marginTop: 8 }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
                {
                  type: "password",
...
function BarRow({ label, used }) {
  const frac = used === void 0 ? 0 : Math.min(1, Math.max(0, used / 100));
  const color = used === void 0 ? "var(--dsw-alias-border-l3)" : used >= 90 ? "var(--dsw-alias-state-error-primary)" : "var(--dsw-alias-state-business-primary)";
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: 10 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", gap: 12 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontVariantNumeric: "tabular-nums", color: "var(--dsw-alias-label-tertiary)" }, children: [
        pct(used),
        " \u5DF2\u7528"
      ] })
    ] }),
